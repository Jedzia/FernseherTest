...
set PATH=D:\Program Files\ffmpeg\bin;E:\Devel\CPP\Libs\QT4\bin;D:\Program Files (x86)\ActivePerl_64_bit\Perl64\site\bin;D:\Program Files (x86)\ActivePerl_64_bit\Perl64\bin;%PATH%;
if "%PLATFORM%" == "X64" (
	set PLATFORM=x64
)
